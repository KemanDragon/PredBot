		...
		*/
		...
		private static readonly Dictionary<OptionSet, OptionSet> ResponseOptions = new Dictionary<OptionSet, OptionSet> {
            ...
            }] = new OptionSet()
            {
				Options = new string[]
                {
					"Hello {USERPING}! Predecessor Early Access is confirmed DECEMBER 1ST! https://www.youtube.com/watch?v=JHpJZ6okj3A You can buy into EA on December first! Check pricing bundle information here: https://imgur.com/ky22hz0 Be sure to watch <514802553213550602> & <943943882926866542> for updates!"
				}
            },
			*/
            #endregion
            #region Oricord Stuff
			#region Greetings
			[new OptionSet() {
				Options = new string[] {
					"{GREETING} {ORIBOT}"
